...
variable customer_contacts_email { default = "DL_RedRock_MgdSrv_OS@dxc.com" }
variable exadata_infra_display_name { default = "EE-MEL-EXACS-INFRA" }
...
variable exadb_cluster_name { default = "aeocidb01pc" }
...
variable exadb_cluster_display_name { default = "EE-MEL-PRD-EXACS-DB" }
variable cluster_gi_version { default = "19.0.0.0" }
variable cluster_hostname { default = "aeocidb01vr" }
...
variable pdb_admin_password_19c { default = "RAbbithole1234#_" }
variable admin_password_11g { default = "RAbbithole1234#_" }
variable admin_password_19c { default = "RAbbithole1234#_" }
variable pluggable_database_tde_wallet_password { default = "RAbbithole1234#_" }
